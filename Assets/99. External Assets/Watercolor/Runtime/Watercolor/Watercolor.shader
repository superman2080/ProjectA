...
Shader "Hidden/VolFx/Watercolor"
{
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma multi_compile_local _PAPER_GRANULATION _
            ...
            half4 frag(frag_in i) : SV_Target
            {
                ...
                float paperNoise = paper.r;
                float pigment = saturate(flowLength * 6.0);
                result.rgb *= lerp(
                    1.0,
                    lerp(0.9, 10.15, paperNoise),
                    pigment * _Granulation
                );
